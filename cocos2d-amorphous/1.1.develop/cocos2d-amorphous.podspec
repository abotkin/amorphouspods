Pod::Spec.new do |s|
  s.name         =  'cocos2d-amorphous'
  s.license      =  { :type => 'MIT', :file => 'LICENSE_cocos2d.txt' }
  s.version      =  '1.1.develop'
  s.summary      =  'cocos2d for iPhone is a framework for building 2D games, demos, and other graphical/interactive applications.'
  s.description  =  'cocos2d for iPhone is a framework for building 2D games, demos, and other graphical/interactive applications for iPod Touch, iPhone, iPad and Mac. It is based on the cocos2d design but instead of using python it, uses Objective-C.  This is a modified pod spec that fixes the lack of FontLabel on GitHub.'
  s.homepage     =  'http://www.cocos2d-iphone.org'
  s.author       =  { 'Ricardo Quesada' => 'ricardoquesada@gmail.com', 'Zynga Inc.' => 'https://zynga.com/' }
  s.source       =  {:git => 'https://github.com/cocos2d/cocos2d-iphone.git', :commit => 'c63149243581ee6d34d5b9038c5a11f2522ceb34'}
  ...
  s.subspec 'cocos2d' do |cc|
    ...
    cc.ios.dependency 'fontlabel-amorphous'
  end
